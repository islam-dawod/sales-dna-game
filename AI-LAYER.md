...
### 6.2 · الحساب في PHP — وتصحيح للمقياس

الوثيقة تقترح `cosine similarity`، وهو المقياس الصحيح لمتجه نصّي عالي الأبعاد لأن
**الاتجاه** هو ما يحمل المعنى فيه. لكنه **مقياس خاطئ للأبعاد الستة**: كل القيم موجبة
ومتقاربة المقدار، فكل متجهين يشيران تقريباً إلى نفس الاتجاه ويعطي الجيب 0.98–1.00
للجميع — صحيح حسابياً وعديم الفائدة للترتيب.

قياساً على بروفايلات فعلية: ثلاثة موظفين أقوياء وثلاثة ضعفاء حصلوا كلهم على **98–99%**
مقابل نفس المرشّح. والفارق بين قوي وضعيف: **0.5 نقطة بالجيب مقابل 2.9 بالمسافة** —
أي أن المسافة تفرّق ستة أضعاف.

**القرار المُنفَّذ في `ai_similarity()`:**

| المتجه | المقياس | السبب |
|---|---|---|
| `trait-v1` (6 أبعاد) | متوسط الفرق المطلق | يفرّق فعلاً · ويطابق `Engine.similarity6()` |
| `text-embedding-*` (1536) | `cosine` | الاتجاه هو المعنى في الفضاء عالي الأبعاد |

الفائدة الثانية للاختيار الأول: المقياس **نفس معادلة الواجهة**، فالرقم الذي يعرضه
`ai/similar` والرقم الذي يعرضه تقرير المرشّح لنفس الزوج **رقم واحد** لا رقمان متناقضان.
