...
(function (root) {
  ...
  var DICT = {
    ...
    bench_def:      { ar: 'تعريف مجموعة المقارنة', en: 'Benchmark group definition' },
    bench_months:   { ar: 'أقدمية لا تقل عن', en: 'Service at least' },
    bench_streak:   { ar: 'أشهر متتالية فوق الهدف', en: 'Consecutive months above' },
    months_unit:    { ar: 'شهراً', en: 'months' },
    bench_note:     { ar: 'من يتجاوز النسبة لكنه خارج التعريف (أقدمية أقل أو تتالٍ أقصر) لا يُحسب في أي من المجموعتين — عدّه ضعيفاً سيكون خطأ صريحاً.',
                      en: 'Someone above the percentage but outside the definition — less service, or a shorter streak — is counted in neither group: calling them a low performer would be plainly wrong.' },
    excluded_n:     { ar: 'خارج التعريف', en: 'Outside the definition' },
    tier_insufficient:{ ar: 'بيانات غير كافية', en: 'Insufficient data' },
    tier_preliminary: { ar: 'نمط أولي', en: 'Preliminary pattern' },
    tier_medium:      { ar: 'ثقة متوسطة', en: 'Medium confidence' },
    tier_strong:      { ar: 'مجموعة بيانات قوية', en: 'Strong dataset' },
    tier_note:      { ar: 'هذه الحدود نقطة بداية تُعاير على بياناتكم، وليست قاعدة إحصائية عامة.',
                      en: 'These tiers are a starting point to calibrate against your own data, not a universal statistical law.' },
    /* ---- AI / similarity ---- */
    ai_layer:       { ar: 'طبقة التشابه', en: 'Similarity layer' },
    ai_build:       { ar: 'توليد المتجهات', en: 'Build vectors' },
    ai_vectors_n:   { ar: 'متجهات مخزّنة', en: 'Vectors stored' },
    ai_local_note:  { ar: 'المتجهات تُحسب من الأبعاد الستة على جهازك وتُخزَّن على سيرفركم. لا شيء يُرسل لأي جهة خارجية إلا إذا أضفت مفتاح OpenAI في config.php.',
                      en: 'Vectors are computed from the six dimensions in your browser and stored on your own server. Nothing is sent to any third party unless you add an OpenAI key to config.php.' },
    ai_nearest:     { ar: 'أقرب الموظفين', en: 'Nearest employees' },
    ai_similarity:  { ar: 'التشابه', en: 'Similarity' },
    ai_attainment:  { ar: 'الأداء الفعلي', en: 'Actual attainment' },
    ai_predictive:  { ar: 'المؤشّر التنبؤي', en: 'Predictive indicator' },
    ai_of_n:        { ar: '{hit} من {of} موظفاً بروفايلهم مشابه تجاوزوا الهدف',
                      en: '{hit} of {of} employees with a similar profile cleared target' },
    ai_zero_weight: { ar: 'لا يدخل نسبة التطابق: حجم البيانات لا يحمله بعد.',
                      en: 'Not counted toward the match: the dataset cannot carry it yet.' },
    ai_no_vector:   { ar: 'لا يوجد متجه لهذا الشخص — اضغط «توليد المتجهات».',
                      en: 'No vector for this person — press Build vectors.' },
    ai_audit_title: { ar: 'سجل نداءات الذكاء', en: 'AI call log' },
    ai_key_absent:  { ar: 'لا مفتاح OpenAI — الطبقة تعمل محلياً', en: 'No OpenAI key — the layer runs locally' },
    ai_key_present: { ar: 'مفتاح OpenAI مضبوط', en: 'OpenAI key configured' },
    /* ---- system health ---- */
    ...
    month_col:      { ar: 'الشهر', en: 'Month' },
    target_col:     { ar: 'الهدف', en: 'Target' },
    sales_col:      { ar: 'المبيعات', en: 'Sales' },
    deals_col:      { ar: 'الصفقات', en: 'Deals' },
    pct_col:        { ar: '% الهدف', en: 'Target %' },
    attend_col:     { ar: 'حضور %', en: 'Attend %' },
    late_col:       { ar: 'تأخير', en: 'Late' },
    absence_col:    { ar: 'غياب', en: 'Absence' },
    mgr_col:        { ar: 'تقييم', en: 'Rating' },
    auto_pct_note:  { ar: 'اكتب الهدف والمبيعات وتُحسب النسبة تلقائياً. الشهر الذي لا نسبة له ولا أرقام يُحسب منها لا يُحفظ.',
                      en: 'Enter target and sales and the percentage is worked out for you. A month with no percentage and nothing to derive one from is not saved.' },
    months_saved:   { ar: 'شهراً محفوظاً', en: 'months saved' },
    add_year:       { ar: 'أضف 12 شهراً', en: 'Add 12 months' },
    /* ---- target hitters / data quality ---- */
    nav_hitters:    { ar: 'من يحقّق الهدف', en: 'Target hitters' },
    hitters_q:      { ar: 'لماذا ينجح من ينجح؟', en: 'Why do the successful succeed?' },
    hitters_sub:    { ar: 'الاختيار بالأرقام الفعلية لا بتصنيف المدير', en: 'Selected by measured attainment, not by the manager label' },
    hit_threshold:  { ar: 'حدّ تحقيق الهدف', en: 'Target threshold' },
    hit_group:      { ar: 'يحقّقون الهدف', en: 'Hit target' },
    oth_group:      { ar: 'دون الهدف', en: 'Below target' },
    gap_col:        { ar: 'الفارق', en: 'Gap' },
    mean_col:       { ar: 'المتوسط', en: 'Mean' },
    median_col:     { ar: 'الوسيط', en: 'Median' },
    sd_col:         { ar: 'الانحراف', en: 'SD' },
    range_col:      { ar: 'المدى', en: 'Range' },
    v_strong:       { ar: 'يفرّق بقوة', en: 'Strong differentiator' },
    v_moderate:     { ar: 'يفرّق', en: 'Differentiates' },
    v_slight:       { ar: 'فارق طفيف', en: 'Slight edge' },
    v_none:         { ar: 'لا يفرّق', en: 'No real difference' },
    v_inverse:      { ar: 'أعلى عند من دون الهدف', en: 'Higher below target' },
    sh_consistent:  { ar: 'مشترك بثبات', en: 'Consistently shared' },
    sh_mixed:       { ar: 'متفاوت', en: 'Mixed' },
    sh_scattered:   { ar: 'مبعثر', en: 'Scattered' },
    hit_not_enough: { ar: 'لا يكفي للحكم: نحتاج 3 على الأقل في كل مجموعة، مع أرقام مبيعات وتقييم مكتمل.',
                      en: 'Not enough to judge: we need at least 3 in each group, with sales numbers and a completed assessment.' },
    hit_no_diff_note:{ ar: 'الصفات التي لا تفرّق مهمة كالتي تفرّق: فارق نقطتين ليس سبباً للنجاح ولا يجوز بناء قرار عليه.',
                      en: 'The traits that do not separate matter as much as the ones that do: a two-point edge is not a reason for success and must not carry a decision.' },
    hit_missing:    { ar: 'مفحوصون بلا أرقام: {a} · لديهم أرقام بلا فحص: {b}', en: 'Assessed without numbers: {a} · numbers without an assessment: {b}' },
    dev_priorities: { ar: 'أولويات التطوير', en: 'Development priorities' },
    dev_note:       { ar: 'فجوات مقابل معيار من يحقّقون الهدف — مرتّبة بحيث تأتي الصفات التي تفرّق فعلاً أولاً.',
                      en: 'Gaps against the benchmark of people who hit target — ordered so the traits that actually separate come first.' },
    dev_none:       { ar: 'لا فجوات جوهرية مقابل من يحقّقون الهدف.', en: 'No material gaps against the people who hit target.' },
    benchmark_col:  { ar: 'المعيار', en: 'Benchmark' },
    matters_tag:    { ar: 'يفرّق', en: 'separates' },
    data_quality:   { ar: 'اكتمال بيانات الموظف', en: 'Employee data quality' },
    miss_assessment:{ ar: 'لم يُجرِ التقييم', en: 'No assessment' },
    miss_target:    { ar: 'لا أرقام هدف', en: 'No target numbers' },
    miss_history6:  { ar: 'سجل أقل من 6 أشهر', en: 'History under 6 months' },
    miss_attendance:{ ar: 'لا بيانات حضور', en: 'No attendance data' },
    miss_manager:   { ar: 'لا تقييم مدير', en: 'No manager rating' },
    miss_group:     { ar: 'غير مصنّف', en: 'Unclassified' },
    major_diff:     { ar: 'أبرز الفروقات', en: 'Major differences' },
    similar_traits: { ar: 'متقاربون في', en: 'Similar in' },
    /* ---- result upload ---- */
    ...
    level_time_note:{ ar: 'لديك {t} لإكمال هذه المرحلة — الوقت يبدأ عند الضغط',
                      en: 'You have {t} to finish this level — the clock starts when you press' },
    times_up:       { ar: 'انتهى الوقت', en: 'Time is up' },
    times_up_note:  { ar: 'انتهى وقت هذه المرحلة — ننتقل تلقائياً إلى التالية',
                      en: 'This level is over — moving on automatically' },
    remaining:      { ar: 'متبقٍّ', en: 'remaining' },
    timer_on:       { ar: 'مؤقّت المراحل', en: 'Level timer' },
    level_secs:     { ar: 'مدة كل مرحلة', en: 'Time per level' },
    timer_note:     { ar: 'المؤقّت لكل مرحلة على حدة لا للاختبار كله. عند انتهاء الوقت تُغلق المرحلة تلقائياً وتُسجَّل الأسئلة المتبقية كـ«بلا إجابة» لا كإجابات خاطئة.',
                      en: 'The clock is per level, not for the whole assessment. When it runs out the level closes automatically and anything left is recorded as unanswered, not as a wrong answer.' },
    nav_timing:     { ar: 'الوقت والسرعة', en: 'Time and speed' },
    timing_title:   { ar: 'تحليل ضغط الوقت', en: 'Time pressure analysis' },
    completeness:   { ar: 'اكتمال البيانات', en: 'Data completeness' },
    unanswered:     { ar: 'بلا إجابة', en: 'Unanswered' },
    avg_response:   { ar: 'متوسط زمن الإجابة', en: 'Average answer time' },
    fastest:        { ar: 'الأسرع', en: 'Fastest' },
    slowest:        { ar: 'الأبطأ', en: 'Slowest' },
    total_q_time:   { ar: 'الزمن الكلي للأسئلة', en: 'Total question time' },
    timed_out_lv:   { ar: 'مراحل انتهى وقتها', en: 'Levels that ran out' },
    per_level:      { ar: 'حسب المرحلة', en: 'By level' },
    answered_col:   { ar: 'أُجيب', en: 'Answered' },
    time_col:       { ar: 'الزمن', en: 'Time' },
    speed_note:     { ar: 'السرعة بيانات إضافية لا حكم: لا نستنتج أن الأسرع أفضل ولا أن الأبطأ أضعف، حتى تُثبت بياناتكم أن الموظفين الأقوياء يختلفون فعلاً في سرعة القرار.',
                      en: 'Speed is an extra observation, not a verdict: faster is not assumed better and slower is not assumed weaker, until your own data shows the strong employees really do differ in decision pace.' },
    completeness_low:{ ar: 'اكتمال منخفض — النتيجة محسوبة من الأسئلة المُجابة فقط، فاقرأها بحذر.',
                      en: 'Low completeness — the score is computed from the answered questions only, so read it with care.' },
    not_timed:      { ar: 'أُجري هذا التقييم بدون مؤقّت', en: 'This assessment was taken without a timer' },
